...
public class BookDaoJdbc implements BookDao {
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books by categoryId " + categoryId, e);
        }
        return books;
    }
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding random books by categoryId " + categoryId, e);
        }
        return books;
    }
